...
def generate_data(data_size=(5000, 300), str_size=5):
    ...
    :param data_path: the output path of the data
...
{% endcodeblock %} 分别测试数据量为 (5000\*300)、(10000\*600)、(15000\*900) 及 (20000\*1200) 四种情况下字符串长度为 5, 10, 20 的内存使用情况，结果如下

<center>表1 字符串长度为 5 的 DataFrame 类型变量内存使用情况</center>

| |str_df <br> *object(300)*|precision_64_df <br> *datetime64\[ns\](2)* <br> *float64(98)* <br> *int64(100)* <br> *object(100)*|precision_32_df <br> *datetime64\[ns\](2)* <br> *float32(98)* <br> *uint8(100)* <br> *object(100)*|str2category_df <br> *datetime64\[ns\](2)* <br> *float32(98)* <br> *uint8(100)* <br> *category(100)*|
| :------ | :------: | :------: | :------: | :-----: |
...
<center>表2 字符串长度为 10 的 DataFrame 类型变量内存使用情况</center>
...
<center>表3 字符串长度为 20 的 DataFrame 类型变量内存使用情况</center>
...
<center>表4 保存预处理结果时间消耗统计表</center>
